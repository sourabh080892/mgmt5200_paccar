...
part_by_fill <- left_join(part_information, demand_fill, by = c("dim"="dim")) %>%
                  select(year, dim, marketing_category, velocity, on_hand, on_order, lead_time, vndr_id, safety_stock_days, safety_stock_qty, days_on_hand, part_cost, trp_ind, mx_ind, ngp_ind, lfna_ind, lfna_4c_ind, length, width, height, rfill, nfill, rhit_cost)

part_by_demand_fill <- left_join(part_by_fill, annual_demand, by = c("dim"="dim")) %>%
                  select(year, dim, marketing_category, velocity, on_hand, on_order, lead_time, vndr_id, safety_stock_days, safety_stock_qty, days_on_hand, part_cost, trp_ind, mx_ind, ngp_ind, lfna_ind, lfna_4c_ind, length, width, height, rfill, nfill, rhit_cost, "2014", "2015", "2016", "2017", "2018", "2019")
